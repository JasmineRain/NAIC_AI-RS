...
class RendNet(nn.Module):
    def __init__(self, n_class):
        ...
        self.mlp3 = MLP(fc_dim_in=1032, fc_dims=[256, 256, 256], num_classes=n_class)
        self.mlp2 = MLP(fc_dim_in=520, fc_dims=[256, 256, 256], num_classes=n_class)
        self.mlp1 = MLP(fc_dim_in=264, fc_dims=[256, 256, 256], num_classes=n_class)
        self.mlp0 = MLP(fc_dim_in=72, fc_dims=[256, 256, 256], num_classes=n_class)
        self.mlp_refine = MLP(fc_dim_in=72, fc_dims=[256, 256, 256], num_classes=n_class)
