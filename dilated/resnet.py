...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, dilated=True, norm_layer=SyncBN2d, multi_grid=False, multi_dilation=None):
        self.inplanes = 64
...
def resnet50(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.load("./pretrained_models/resnet50.pth"))
    return model
